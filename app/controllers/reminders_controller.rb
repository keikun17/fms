class RemindersController < ApplicationController
  ...
  def index
    ...
    if params[:type].blank?
      ...
      if params[:expired].eql?("true")
        @reminders = @fleet.reminders.expired.where(:reminder_type_id => [params[:type]])      
      else
        @reminders = @fleet.reminders.upcoming.where(:reminder_type_id => [params[:type]])
      end
    end
